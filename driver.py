...
class RandomSeedData(df.DataFlow):
    def __init__(self, size=100, datadir='data/', verbose=True):
...
if __name__ == '__main__':
    ...
    if args.sample:
        ...
        # Create a dataflow
        # TODO
        ds_train = RandomSeedData(size=128, datadir='data/CVPPP/db_train')
        augs = [imgaug.ResizeShortestEdge(270),
                imgaug.RandomCrop(256), 
        ...
        for epoch in range(EPOCH):
            for mb_train in ds_train.get_data():
                ...
                if step % 10000 == 0:
                    ...
                    torch.save(net.cpu().state_dict(), "driver.pkl")
                    # net.cuda()
                    net = net.to(xpu)
